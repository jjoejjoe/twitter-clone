...
export default function AuthPage() {
    ...
    const url = "https://10d63094-6fdb-4799-9a00-a4d8ebefac39-00-3ci21pb2cazbu.worf.replit.dev";
    ...
    return (
        <Row>
            ...
            <Col sm={6} className="p-4">
                ...
                <Col sm={5} className="d-grip gap-2">
                    ...
                    <Modal.Body>
                        ...
                        >
                            ...
                            <p style={{ fontSize: "12px" }}>
                                ...
                                purposes outlines in our Privacy Policy, like keeping your account
